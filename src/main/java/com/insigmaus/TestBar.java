...
public class TestBar {
    ...
    private static final String SBAR_TABLE_NAME = "bar";
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            try {
            	new TestBar(HBaseConfiguration.create()).runTests(cmds);
            } catch (Exception e) {
            	if (yourSelected == 2) {
    ...
    public TestBar(Configuration conf) {
        this.conf = conf;
    }
    ...
    private void teardownTables() throws IOException {
        ...
        if (TestBar.testCaseToRun == 2 || TestBar.testCaseToRun == 3) {
            return;
        }
    ...
    static class BarTableTest extends Test {
        ...
        static final byte[] COLUMN = Bytes.toBytes("b,f,o,h,l,L,v");
    ...
    static class BarSequentialWriteTest extends BarTableTest {
        ...
        void testRow(final int i) throws IOException {
            ...
            put.add(FAMILY_NAME, COLUMN, value);

            put.setWriteToWAL(writeToWAL);

            collectRowStatistics(key.length + value.length, put.heapSize());
    ...
    static class BarFilteredScanTest extends BarTableTest {
        ...
        public void scaneByPrefixFilter(HTable table, Set<String> set) {
            ...
            try {
                ...
                int count = 0;
                for (Result r : rs) {
                    collectRowStatistics(r.getRow().length + r.getValue(FAMILY_NAME, COLUMN).length,
                                         r.getWritableSize());
                    ++count;
                }
