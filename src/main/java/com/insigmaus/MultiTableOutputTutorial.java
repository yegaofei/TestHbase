...
/**
 * This class demonstrates the use of the MultiTableOutputFormat class. Using
 * this class we can write the output of a Hadoop map reduce program into
 * different HBase table.
 * 
...
public class MultiTableOutputTutorial extends Configured implements Tool {
    ...
    private static final String CMDLINE = "com.wildnove.tutorial.MultiTableOutputTutorial <inputFile> [-n name] [-s]";
    ...
    /**
     * Here we configure our job to use MultiTableOutputFormat class as map
     * reduce output. Note that we use 1 reduce only for debugging purpose, but
     * you can use more than 1 reduce.
     */
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException,
            ...
            for (Text value : values) {
                ...
                if (valueSplitted.length == 2) {
                    ...
                    // Compute some counters: number of different sizes for a
                    // brand
